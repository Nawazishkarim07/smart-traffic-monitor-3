...
export default function AdvancedFilters({ filters, onFiltersChange }: AdvancedFiltersProps) {
  ...
  const getActiveFiltersCount = () => {
    ...
    if (filters.showIncidents === false) count++ // Only count if explicitly false
    if (filters.showConstruction === false) count++ // Only count if explicitly false
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-3 bg-gradient-to-r from-blue-50/50 to-purple-50/50 rounded-lg backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {filters.showIncidents === false && (
                <Badge variant="secondary" className="bg-red-100 text-red-800">
                  Incidents: Hidden
                </Badge>
              )}
              {filters.showConstruction === false && (
                <Badge variant="secondary" className="bg-red-100 text-red-800">
                  Construction: Hidden
                </Badge>
              )}
              {filters.minReliability > 50 && (
                <Badge variant="secondary" className="bg-orange-100 text-orange-800">
                  Min Reliability: {filters.minReliability}%
                </Badge>
              )}
              {getActiveFiltersCount() === 0 && (
